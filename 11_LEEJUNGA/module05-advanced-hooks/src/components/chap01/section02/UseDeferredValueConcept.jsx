...
function SlowList({ text }) {
  ...
  return (
    <ul style={{ maxHight: "200px", overflowY: "auto", marginTop: "10px" }}>
      {items}
    </ul>
  );
}
  ...
  return (
    <div>
      ...
      <p>
        ...
        리스트는 약간의 지연 후에 업데이트된다. 이는 useDefferredValue가 무거운
        렌더링(SlowList)을 낮은 우선순위로 처리하기 떄문이다.
      </p>
    </div>
  );
}
