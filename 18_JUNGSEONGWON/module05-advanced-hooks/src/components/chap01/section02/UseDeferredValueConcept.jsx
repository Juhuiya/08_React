...
export default function UseDeferredValueConcept() {
  ...
  return (
    <div>
      ...
      <SlowList text={input} />
      <p>
        입력창에 텍스트를 빠르게 입력하면, "즉시 입력값은 즉시 반영되고 입력창은 반응성을 유지한다"
        반면 , "지연된 입력값"과 그에 기반하는 리ㅅ트는 약간의 지연 후에 업데이트 된다. 
        이는 useDefferedValue가 무거운 랜더링(SlowList)을 낮은 우선 순위로 처리하기 때문이다.
      </p>
    </div>
  );
}
