...
export default function layout({ children, modal, auth }) {
  return (
    <html>
      <body>
        ...
        <main style={{ border: "1px solid green", padding: "10px" }}>{children}</main>

        {/* @modal의 page가 렌더링된다. */}
        <aside style={{ border: "1px solid blue", padding: "10px" }}>{modal}</aside>

        {/* @auth의 page가 렌더링된다. */}
        <section style={{ border: "1px solid red", padding: "10px" }}>{auth}</section>
