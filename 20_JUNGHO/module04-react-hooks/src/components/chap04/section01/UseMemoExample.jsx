...
export default function UseMemoExample() {
  ...
  return (
    <>
      ...
      <button onClick={() => setRenderingCount((prev) => prev + 1)}>{renderingCount}번 렌더링</button>

      {/* <input type="number" className="border-1" value={nonMemoNumber} onChange={nonMemoHandler} />
